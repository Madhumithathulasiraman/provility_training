...
class ExerciseAnswer9113(Scene):
    def construct(self):
        ...
        axes.x_axis.set_stroke(width=3.5)
        axes.y_axis.set_stroke(width=3.5)
        ...
        arrow_1 = Arrow(LEFT*3, RIGHT*3, color="#6A0B37", stroke_width=4, tip_length=0).shift(DOWN*0.7 + LEFT*1).scale(0.95)

        arrow_2 = Arrow(RIGHT*3, LEFT*3, color="#6A0B37", stroke_width=4, tip_length=0).shift(DOWN*0.7 + RIGHT*4.2).scale(0.8)


        hole1 = Circle(radius=0.10, stroke_color="#6A0B37", stroke_width=4, fill_opacity=1,fill_color=WHITE)
        hole1.move_to(arrow_1.get_end())

        hole2 = Circle(radius=0.10, stroke_color="#6A0B37", stroke_width=4, fill_opacity=1,fill_color=WHITE)
        hole2.move_to(arrow_2.get_end())
        ...
        label_2.next_to(arrow_2.get_end(), RIGHT*2+ DOWN*0.5)

        self.add(arrow_1, arrow_2, hole1, hole2, label_1, label_2, label_3)
