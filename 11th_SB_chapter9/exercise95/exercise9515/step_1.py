...
class ExerciseAnswer9515a(Scene):
    def construct(self):
        ...
        right_curve = axes.plot(lambda x: 1.3*(x-x0)**2 + 2.2,x_range=[x0, 4],color=BLUE,stroke_width=5)
        ...
        arrow2= Arrow(start=RIGHT * 2,end=LEFT * 2,color=BLUE,buff=0).scale(0.65).shift(RIGHT*2.6+DOWN*1)
