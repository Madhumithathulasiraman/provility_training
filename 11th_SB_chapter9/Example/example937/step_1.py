...
class Example937(Scene):
    def construct(self):
        ...
        # Axes
        axes=Axes(x_range=[-20, 159, 10],y_range=[-4, 27, 2],y_length=18,axis_config={"color":BLACK, "stroke_width":4,"tick_size": 0.06},x_axis_config={"include_ticks":True},tips=False)
        ...
        labels1=axes.get_axis_labels(MathTex("x",color=BLACK)).shift(DOWN*3)
        labels2=axes.get_axis_labels(MathTex("y",color=BLACK)).shift(UP*12.5+LEFT*10.5)
        labels3=axes.get_axis_labels(MathTex("x'",color=BLACK)).shift(LEFT*12.5+DOWN*3)
        labels4=axes.get_axis_labels(MathTex("y'",color=BLACK)).shift(DOWN*5.3+LEFT*10.5)
        f1=lambda x: 0.16 * x
        line_1=axes.plot(f1,x_range=[0,99],color=GREEN,stroke_width=4,use_smoothing=False)

    
        f2=lambda x: 0.140* x
        line_2=axes.plot(f2,x_range=[100.17, 150],color=PINK,stroke_width=4,use_smoothing=False)

        
        dot_line= DashedLine(axes.c2p(-20, 15.8),axes.c2p(100, 15.8),color=GREEN,dash_length=0.15)
        dot_line2=DashedLine(axes.c2p(-20, 13.9),axes.c2p(100, 13.9),color=PINK,dash_length=0.15)
        dot_line3=DashedLine(axes.c2p(98.5, 0),axes.c2p(100,15.8),color=GREEN,dash_length=0.15)             
        ...
        eq_label=MathTex("y=0.16x",color=BLACK).scale(0.9)
        eq_label.rotate(55 * DEGREES).shift(DOWN*1.5)
        eq_label2=MathTex("y=0.14x",color=BLACK).move_to(line_2).scale(0.9)
        eq_label2.rotate(55 * DEGREES).shift(DOWN*0.9)
        ...
        label1 = MathTex("(10,\,1.6)", color=BLACK,font_size=22).scale(1)
        label1.move_to(dot1).rotate(PI/3.5).shift(UP*0.4+LEFT*0.15+DOWN*0.2)
        ...
        label2= MathTex("(20,\,3.2)", color=BLACK,font_size=22).scale(1)
        label2.move_to(dot2).rotate(PI/3.5).shift(UP*0.4+LEFT*0.15+DOWN*0.2)
        ...
        label3 = MathTex("(30,\,4.8)", color=BLACK,font_size=22).scale(1)
        label3.move_to(dot3).rotate(PI/3.5).shift(UP*0.4+LEFT*0.15+DOWN*0.2)
        ...
        label4= MathTex("(40,\,6.4)", color=BLACK,font_size=22).scale(1)
        label4.move_to(dot4).rotate(PI/3.5).shift(UP*0.4+LEFT*0.15+DOWN*0.2)
        ...
        label5= MathTex("(50,\,8)", color=BLACK,font_size=22).scale(1)
        label5.move_to(dot5).rotate(PI/3.5).shift(UP*0.4+LEFT*0.15+DOWN*0.2)
        ...
        label6 = MathTex("(60,\,9.6)", color=BLACK,font_size=22).scale(1)
        label6.move_to(dot6).rotate(PI/3.5).shift(UP*0.4+LEFT*0.15+DOWN*0.2)
        ...
        label7 = MathTex("(70,\,11.2)", color=BLACK,font_size=22).scale(1)
        label7.move_to(dot7).rotate(PI/3.5).shift(UP*0.4+LEFT*0.15+DOWN*0.2)
        ...
        label8 = MathTex("(80,\,12.8)", color=BLACK,font_size=22).scale(1)
        label8.move_to(dot8).rotate(PI/3.5).shift(UP*0.4+LEFT*0.15+DOWN*0.2)
        ...
        label9 = MathTex("(90,\,14.4)", color=BLACK,font_size=22).scale(1)
        label9.move_to(dot9).rotate(PI/3.5).shift(UP*0.4+LEFT*0.15+DOWN*0.2)
        circle9= Circle(radius=0.10,color="#F5277D",stroke_width=3).move_to(dot9.get_center())
        dot10 = Dot(axes.c2p(100, 16), color="#3827F5").scale(0.5).shift(DOWN*0.1)
        label10 = MathTex("(100,\,16)", color=BLACK,font_size=22).scale(1)
        label10.move_to(dot10).rotate(PI/3.5).shift(UP*0.4+LEFT*0.15+DOWN*0.2)
        ...
        dot_1=Dot(axes.c2p(100,14),color="#3827F5").scale(0.5).shift(DOWN*0.07)
        label_1 = MathTex("(100,\,14)", color=BLACK,font_size=22).scale(1)
        label_1.move_to(dot_1).rotate(PI/3.5).shift(UP*0.4+LEFT*0.15+DOWN*0.2)
        circle_1= Circle(radius=0.10,color="#F5277D",stroke_width=3).move_to(dot_1.get_center())
        dot_2= Dot(axes.c2p(110,15.4), color="#3827F5").scale(0.5)
        label_2= MathTex("(110,\,15.4)", color=BLACK,font_size=22).scale(1)
        label_2.move_to(dot_2).rotate(PI/3.5).shift(UP*0.3+LEFT*0.20+RIGHT*0.1)
        ...
        label_3= MathTex("(120,\,16.8)", color=BLACK,font_size=22).scale(1)
        label_3.move_to(dot_3).rotate(PI/3.5).shift(UP*0.45+LEFT*0.30+RIGHT*0.3)
        ...
        label_4= MathTex("(130,\,18.2)", color=BLACK,font_size=22).scale(1)
        label_4.move_to(dot_4).rotate(PI/3.5).shift(UP*0.55+LEFT*0.40+RIGHT*0.5)
        ...
        label_5= MathTex("(140,\,19.6)", color=BLACK,font_size=22).scale(1)
        label_5.move_to(dot_5).rotate(PI/3.5).shift(UP*0.65+LEFT*0.50+RIGHT*0.7)
        circle_5= Circle(radius=0.10,color="#F5277D",stroke_width=3).move_to(dot_5.get_center())
       
        self.add(dot_1,label_1,circle_1,dot_2,label_2,circle_2,dot_3,label_3,circle_3,dot_4,label_4,circle_4,dot_5,label_5,circle_5)

        
        y_label = Text("(cost)",color=BLACK).scale(0.6).shift(UP*6.7+LEFT*5.4)
        y_arrow = Arrow(start=axes.c2p(-10,23.5),end=axes.c2p(-10, 26),buff=0,color="#27D6F5",stroke_width=4,tip_length=0.3)
